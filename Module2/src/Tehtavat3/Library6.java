...
public class Library6 {
    ...
    public void addUser(User user) {
        if (!libraryUsers.containsKey(user)) {
            ...
            System.out.println("Tehtavat3.User already exists.");
        }
    }
    ...
    public void removeUser(User user) {
        if (libraryUsers.containsKey(user)) {
            ...
            System.out.println("Tehtavat3.User not found.");
        }
    }

    public void displayUsers() {
        System.out.println("Tehtavat3.Library Users and borrowed books:");
...
class LibraryMain6 {
    public static void main(String[] args) {
        ...
        // Creating users:
        User firstUser = new User("First Tehtavat3.User", 25);
        User secondUser = new User("Second Tehtavat3.User", 30);
        User thirdUser = new User("Third Tehtavat3.User", 35);
        // Users borrow books:
