...
public class CoffeeMaker {
    ...
    public void isOff() {
        ...
        if (!on_offSwitch) {
            ...
            System.out.println("Tehtavat1.Coffee maker is already turned off.");
        } else {
            //Jos kahvinkeitin on päällä, niin kahvinkeitin sammutetaan
            System.out.println("Tehtavat1.Coffee maker is turned off.");
            on_offSwitch = false;
        }
    }
    ...
    public void isOn() {
        ...
        if (on_offSwitch) {
            ...
            System.out.println("Tehtavat1.Coffee maker is already turned on.");
        } else {
            //Jos kahvinkeitin ei ole päällä, niin kahvinkeitin käynnistetään
            System.out.println("Tehtavat1.Coffee maker is turned on.");
            on_offSwitch = true;
        }
    }
        ...
        while (true) {
            ...
            switch (command) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Tehtavat1.Coffee type: " + coffeeMaker.getCoffeeType());
                    System.out.println("Tehtavat1.Coffee amount: " + coffeeMaker.getCoffeeAmount());
                    break;
                case 6:
                    System.exit(0);
                    break;
